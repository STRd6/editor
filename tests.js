...
;(function() {
  ...
  this.Builder = function(I) {
    ...
    return {
      ...
      testsCode: function(fileData) {
        return this.build(fileData).then(function(_arg) {
          var distribution;
          distribution = _arg.distribution;
          return distribution["test.js"];
        });
      },
...
;(function() {
  var $root, actions, branch, builder, classicError, confirmUnsaved, distribution, errors, files, filetree, fullName, issues, notices, notify, owner, repo, repository, repositoryLoaded, _ref;
  ...
  actions = {
    ...
    test: function() {
      ...
      return builder.testsCode(filetree.data()).then(function(testsCode) {
        return TestRunner.launch(testsCode);
      }).fail(errors);
    },
    new_file: function() {
      var name;

  ...
  this.Builder = function() {
    ...
    return {
      ...
      program: function(build) {
        ...
        return this.envWrapper(program, build);
      },
      envWrapper: function(program, build) {
      ...
      testScripts: function(fileData) {
        var _this = this;
        return this.build(fileData).then(function(build) {
          var content, distribution, testProgram, _ref;
          distribution = build.distribution;
          content = ((_ref = distribution["test.js"]) != null ? _ref.content : void 0) || "";
          testProgram = _this.envWrapper(content, build);
